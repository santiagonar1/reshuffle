...
CMAKE_FLAGS="-DCMAKE_PROJECT_TOP_LEVEL_INCLUDES=conan_provider.cmake -DCMAKE_CXX_COMPILER:FILEPATH=${MPI_CXX_COMPILER} -DCMAKE_C_COMPILER:FILEPATH=${MPI_CC_COMPILER}"
